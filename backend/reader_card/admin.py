...
class ReaderCardAdmin(admin.ModelAdmin):
    ...
    def halls(self, reader_card: ReaderCard) -> str:
        halls = [hall.name for hall in reader_card.hall_access.all()]
        return ", ".join(halls)
    ...
    @staticmethod
    def reader__last_name(obj: ReaderCard) -> str:
        return obj.reader.last_name

    @staticmethod
    def reader__first_name(obj: ReaderCard) -> str:
